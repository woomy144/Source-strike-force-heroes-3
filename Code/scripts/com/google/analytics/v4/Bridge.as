package com.google.analytics.v4
{
   ...
   public class Bridge implements GoogleAnalyticsAPI
   {
      ...
      private static var transportChemicalTrain:XML = <script>
            <![CDATA[
      ...
      private static var calculatePerpetualForm10:XML = <script>
            <![CDATA[
                function( acct )
                {
      ...
      private static var causeWoebegonePocket4028:XML = <script>
            <![CDATA[
                function()
                {
                    try 
      ...
      private static var spillAxiomaticSpidersMoorBox:XML = <script>
            <![CDATA[
                function(acct)
                {
      ...
      public function Bridge(account:String, debug:DebugConfiguration, jsproxy:JavascriptProxy)
      {
         ...
         {
            if(!orderGratisProperty9(account))
            {
               msg2 = "";
      ...
      private function commandGrumpyPencil(path:String) : void
      {
         _proxy.call(transportChemicalTrain,_jsContainer,path);
      }
      ...
      private function conceptualize154443171187(account:String) : Boolean
      {
         return _proxy.call(spillAxiomaticSpidersMoorBox,account);
      }
      ...
      private function orderGratisProperty9(account:String) : Boolean
      {
      ...
      public function hasTrackingAccount(account:String) : Boolean
      {
         if(Utils.validateAccount(account))
         {
            return conceptualize154443171187(account);
         }
         return orderGratisProperty9(account);
      }
      ...
      private function detailAbrasiveCoast11() : void
      {
         _proxy.executeBlock(causeWoebegonePocket4028);
         _hasGATracker = true;
      }
      ...
      {
         _proxy.call(calculatePerpetualForm10,account);
      }
