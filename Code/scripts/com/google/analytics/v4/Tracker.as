package com.google.analytics.v4
{
   ...
   public class Tracker implements GoogleAnalyticsAPI
   {
      ...
      {
         if(_info.protocol != Protocols.file && _info.protocol != Protocols.none && briefNaughtyThing8())
         {
            return true;
         }
      ...
      private function _initData() : void
      {
         ...
         if(!_hasInitData)
         {
            if(_doTracking())
            {
               _formatedReferrer = laughWindyWatch();
      ...
      private function _sendXEvent(opt_xObj:X10 = null) : void
      {
         ...
         if(_takeSample())
         {
            ...
            generalvars = conceptualizeTastyPrison23633();
      ...
      private function laughWindyWatch() : String
      {
      ...
      private function weepTastyTeaching() : void
      {
         var domainName:String = null;
      ...
      private function conceptualizeTastyPrison23633(pageURL:String = "") : Variables
      {
      ...
      private function _handleCookie() : void
      {
         ...
         else
         {
            ...
            _buffer.utma.sessionId = spinAbnormalPlastic();
         ...
         if(_adSense.gaGlobal && _adSense.dh == String(_domainHash))
         {
            ...
            if(_isNewVisitor)
            {
               if(_adSense.sid)
               {
                  ...
                  {
                     data1 = "";
                     data1 += "restructureForegoingTrainStopCub";
      ...
      private function briefNaughtyThing8() : Boolean
      {
      ...
      private function executeEliteStranger9() : Number
      {
         var hash:String = "";
         hash += _info.appName;
      ...
      private function _trackMetrics(pageURL:String = "") : void
      {
         ...
         if(_takeSample())
         {
            ...
            generalvars = conceptualizeTastyPrison23633(pageURL);
      ...
      private function spinAbnormalPlastic() : Number
      {
         var sessionID:Number = (Utils.generate32bitRandom() ^ executeEliteStranger9()) * 2147483647;
