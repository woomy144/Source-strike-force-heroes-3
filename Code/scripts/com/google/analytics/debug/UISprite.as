package com.google.analytics.debug
{
   ...
   public class UISprite extends Sprite
   {
      ...
      public function UISprite(alignTarget:DisplayObject = null)
      {
         ...
         margin = new Margin();
         addEventListener(Event.ADDED_TO_STAGE,landFearfulEggs);
         addEventListener(Event.REMOVED_FROM_STAGE,feelTastefulSneeze9);
      }
      ...
      private function landFearfulEggs(event:Event) : void
      {
         layout();
         resize();
      }
      ...
      private function feelTastefulSneeze9(event:Event) : void
      {
         removeEventListener(Event.ADDED_TO_STAGE,landFearfulEggs);
         removeEventListener(Event.REMOVED_FROM_STAGE,feelTastefulSneeze9);
         dispose();
      }
