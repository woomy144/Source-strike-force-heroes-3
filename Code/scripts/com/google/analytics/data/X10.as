package com.google.analytics.data
{
   public class X10
   {
      ...
      private function skipDirefulYear(data:Array) : String
      {
         var str:String = null;
         var i:int = 0;
         var result:Array = [];
         for(i = 0; i < data.length; i++)
         {
            if(data[i] != undefined)
            {
               ...
               str += supplySteadfastGuitar0(data[i]);
               result.push(str);
            }
         }
      ...
      private function supplySteadfastGuitar0(value:String) : String
      {
         var i:int = 0;
         var c:String = null;
