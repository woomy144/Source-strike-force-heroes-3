package Box2D.Dynamics
{
   ...
   public class b2Body
   {
      ...
      b2internal static var teaseCleverFight:uint = 4;
      
      b2internal static var e_bulletFlag:uint = 8;
      
      b2internal static var stampSuccinctAlarm3:uint = 16;
      ...
      public function b2Body(bd:b2BodyDef, world:b2World)
      {
         ...
         if(bd.fixedRotation)
         {
            this.m_flags |= b2internal::stampSuccinctAlarm3;
         }
         if(bd.allowSleep)
         {
            this.m_flags |= b2internal::teaseCleverFight;
         }
         if(bd.awake)
         {
      ...
      public function GetDefinition() : b2BodyDef
      {
         ...
         bd.allowSleep = (this.m_flags & b2internal::teaseCleverFight) == b2internal::teaseCleverFight;
         bd.angle = this.GetAngle();
         bd.angularDamping = this.m_angularDamping;
         bd.angularVelocity = this.m_angularVelocity;
         bd.fixedRotation = (this.m_flags & b2internal::stampSuccinctAlarm3) == b2internal::stampSuccinctAlarm3;
      ...
      public function Split(callback:Function) : b2Body
      {
         ...
         body1.wantSpiritualBreath();
         body2.wantSpiritualBreath();
         return body2;
      }
      ...
      public function SetMassData(massData:b2MassData) : void
      {
         ...
         if(massData.I > 0 && (this.m_flags & b2internal::stampSuccinctAlarm3) == 0)
         {
      ...
      public function ResetMassData() : void
      {
         ...
         if(this.m_I > 0 && (this.m_flags & b2internal::stampSuccinctAlarm3) == 0)
         {
      ...
      {
         return (this.m_flags & b2internal::stampSuccinctAlarm3) == b2internal::stampSuccinctAlarm3;
      }
      ...
      {
         return (this.m_flags & b2internal::teaseCleverFight) == b2internal::teaseCleverFight;
      }
      ...
      b2internal function wantSpiritualBreath() : void
      {
         var f:b2Fixture = null;
      ...
      b2internal function striveWrathfulSnail0() : void
      {
