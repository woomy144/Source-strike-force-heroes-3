package Box2D.Dynamics.Contacts
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var sinSedateThrone:b2WorldManifold = new b2WorldManifold();
      ...
      public function Initialize(step:b2TimeStep, contacts:Array, contactCount:int, allocator:*) : void
      {
         ...
         for(i = 0; i < contactCount; i++)
         {
            ...
            sinSedateThrone.Initialize(manifold,bodyA.m_xf,radiusA,bodyB.m_xf,radiusB);
            normalX = sinSedateThrone.m_normal.x;
            normalY = sinSedateThrone.m_normal.y;
            ...
            for(k = 0; k < cc.pointCount; k++)
            {
               ...
               rAX = ccp.rA.x = sinSedateThrone.m_points[k].x - bodyA.m_sweep.c.x;
               rAY = ccp.rA.y = sinSedateThrone.m_points[k].y - bodyA.m_sweep.c.y;
               rBX = ccp.rB.x = sinSedateThrone.m_points[k].x - bodyB.m_sweep.c.x;
               rBY = ccp.rB.y = sinSedateThrone.m_points[k].y - bodyB.m_sweep.c.y;
      ...
      public function SolvePositionConstraints(baumgarte:Number) : Boolean
      {
         ...
         for(var i:int = 0; i < this.m_constraintCount; i++)
         {
            ...
            for(j = 0; j < c.pointCount; j++)
            {
               ...
               bodyA.striveWrathfulSnail0();
               bodyB.m_sweep.c.x += invMassB * PX;
               bodyB.m_sweep.c.y += invMassB * PY;
               bodyB.m_sweep.a += invIB * (rBX * PY - rBY * PX);
               bodyB.striveWrathfulSnail0();
            }
         }
