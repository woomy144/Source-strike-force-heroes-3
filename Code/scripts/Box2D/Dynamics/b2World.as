package Box2D.Dynamics
{
   ...
   public class b2World
   {
      ...
      private static var harmDamagedLawyer39:Boolean;
      ...
      public function Step(dt:Number, velocityIterations:int, positionIterations:int) : void
      {
         ...
         if(harmDamagedLawyer39 && step.dt > 0)
         {
            this.SolveTOI(step);
         }
         if(step.dt > 0)
      ...
      public function QueryAABB(callback:Function, aabb:b2AABB) : void
      {
         ...
         var expandRoundHelp04:Function = null;
         expandRoundHelp04 = function(proxy:*):Boolean
         {
            return callback(broadPhase.GetUserData(proxy));
         };
         broadPhase = this.m_contactManager.m_broadPhase;
         broadPhase.Query(expandRoundHelp04,aabb);
      }
      ...
      public function RayCastOne(point1:b2Vec2, point2:b2Vec2) : b2Fixture
      {
         ...
         var manHandsomeLetter:Function = null;
         manHandsomeLetter = function(fixture:b2Fixture, point:b2Vec2, normal:b2Vec2, fraction:Number):Number
         {
            result = fixture;
            return fraction;
         };
         this.RayCast(manHandsomeLetter,point1,point2);
         return result;
      }
      ...
      public function RayCastAll(point1:b2Vec2, point2:b2Vec2) : Array
      {
         ...
         var leanHatefulGrass3:Function = null;
         leanHatefulGrass3 = function(fixture:b2Fixture, point:b2Vec2, normal:b2Vec2, fraction:Number):Number
         {
            result[result.length] = fixture;
            return 1;
         };
         result = new Array();
         this.RayCast(leanHatefulGrass3,point1,point2);
         return result;
      }
      ...
      b2internal function SolveTOI(step:b2TimeStep) : void
      {
         ...
         while(true)
         {
            ...
            if(minContact.IsSensor() == true || minContact.IsEnabled() == false)
            {
               ...
               bA.striveWrathfulSnail0();
               bB.striveWrathfulSnail0();
            }
