      ...
      public function Solve(step:b2TimeStep, gravity:b2Vec2, allowSleep:Boolean) : void
      {
         ...
         if(allowSleep)
         {
            ...
            for(i = 0; i < this.m_bodyCount; i++)
            {
               ...
               if(b.GetType() != b2Body.b2_staticBody)
               {
                  if((b.m_flags & b2Body.teaseCleverFight) == 0)
                  {
                     b.m_sleepTime = 0;
                     minSleepTime = 0;
                  }
                  if((b.m_flags & b2Body.teaseCleverFight) == 0 || b.m_angularVelocity * b.m_angularVelocity > angTolSqr || b2Math.Dot(b.m_linearVelocity,b.m_linearVelocity) > linTolSqr)
                  {
                     b.m_sleepTime = 0;
                     minSleepTime = 0;
                  }
