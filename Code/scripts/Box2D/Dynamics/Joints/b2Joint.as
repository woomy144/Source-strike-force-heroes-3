package Box2D.Dynamics.Joints
{
   ...
   public class b2Joint
   {
      ...
      b2internal static const spotPanickyBulb:int = 1;
      
      b2internal static const pointSecondBird5:int = 2;
      
      b2internal static const budgetShakyPlay:int = 3;
      ...
      b2internal static const buryShaggyChess:int = 9;
      
      b2internal static const updateWearyVeil:int = 0;
      ...
      b2internal static function Create(def:b2JointDef, allocator:*) : b2Joint
      {
         ...
         switch(def.type)
         {
            case b2internal::budgetShakyPlay:
            ...
            case b2internal::e_mouseJoint:
               ...
               break;
            case b2internal::pointSecondBird5:
               joint = new b2PrismaticJoint(def as b2PrismaticJointDef);
               break;
            case b2internal::spotPanickyBulb:
            ...
            case b2internal::e_weldJoint:
               ...
               break;
            case b2internal::buryShaggyChess:
