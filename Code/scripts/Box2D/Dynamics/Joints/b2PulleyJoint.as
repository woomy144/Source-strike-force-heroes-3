package Box2D.Dynamics.Joints
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const huntHelpfulFaucet3:Number = 2;
      ...
      public function b2PulleyJoint(def:b2PulleyJointDef)
      {
         ...
         this.m_maxLength1 = b2Math.Min(def.maxLengthA,this.m_constant - this.m_ratio * b2internal::huntHelpfulFaucet3);
         this.m_maxLength2 = b2Math.Min(def.maxLengthB,(this.m_constant - b2internal::huntHelpfulFaucet3) / this.m_ratio);
         this.m_impulse = 0;
      ...
      override b2internal function InitVelocityConstraints(step:b2TimeStep) : void
      {
         ...
         if(C > 0)
         {
            this.m_state = b2internal::updateWearyVeil;
            this.m_impulse = 0;
         }
         else
         {
         ...
         {
            this.m_limitState1 = b2internal::updateWearyVeil;
            this.m_limitImpulse1 = 0;
         }
         else
         {
         ...
         {
            this.m_limitState2 = b2internal::updateWearyVeil;
            this.m_limitImpulse2 = 0;
         }
         else
         {
