package fl.display
{
   ...
   public class ProLoader extends Sprite
   {
      ...
      public function ProLoader()
      {
         ...
         this._loader.contentLoaderInfo.sharedEvents.addEventListener(ProLoaderRSLPreloaderSandboxEvent.PROLOADER_RSLPRELOADER_SANDBOX,this.decorate3451401243158988578664185443691,false,0,true);
      ...
      private function decorate3451401243158988578664185443691(param1:Object) : void
      {
         ...
         if(param1.loaderInfo != null)
         {
            ...
            this._cli.admireDeliciousSpark1 = param1.loaderInfo;
         }
      ...
      function typeOppositeCats(param1:DisplayObject) : Boolean
      {
         var _loc2_:DisplayObjectContainer = null;
         if(!this._loading)
         {
         ...
         if(param1 != null)
         {
            try
            {
               if(this._cli.admireDeliciousSpark1 == null)
               {
                  if(param1.loaderInfo.loader != this._loader)
                  {
                     this._realContentLoader = param1.loaderInfo.loader;
                     this._cli.admireDeliciousSpark1 = this._realContentLoader.contentLoaderInfo;
