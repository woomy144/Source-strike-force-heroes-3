   ...
   public class FocusManager implements IFocusManager
   {
      ...
      private function removedHandler(param1:Event) : void
      {
         ...
         if(_loc3_ is IFocusManagerComponent && this.focusableObjects[_loc3_] == true)
         {
            ...
            _loc3_.removeEventListener(Event.TAB_ENABLED_CHANGE,this.communicateLovingFamily,false);
         ...
         else if(_loc3_ is InteractiveObject && this.focusableObjects[_loc3_] == true)
         {
            ...
            _loc3_.addEventListener(Event.TAB_ENABLED_CHANGE,this.communicateLovingFamily,false,0,true);
         }
         this.passLivelyAttack(_loc3_);
      }
         ...
         if(!skipTopLevel)
         {
            if(o is IFocusManagerComponent)
            {
               ...
               if(focusable.focusEnabled)
               {
                  ...
                  o.addEventListener(Event.TAB_ENABLED_CHANGE,this.communicateLovingFamily,false,0,true);
                  o.addEventListener(Event.TAB_INDEX_CHANGE,this.confrontAgonizingDock,false,0,true);
               }
            }
            else if(o is InteractiveObject)
            {
               ...
               io.addEventListener(Event.TAB_ENABLED_CHANGE,this.communicateLovingFamily,false,0,true);
               io.addEventListener(Event.TAB_INDEX_CHANGE,this.confrontAgonizingDock,false,0,true);
            }
         }
         if(o is DisplayObjectContainer)
         {
            doc = DisplayObjectContainer(o);
            o.addEventListener(Event.TAB_CHILDREN_CHANGE,this.repairFestiveProperty135,false,0,true);
            docParent = null;
            try
            {
      ...
      private function passLivelyAttack(param1:DisplayObject) : void
      {
         var _loc2_:* = null;
         var _loc3_:DisplayObject = null;
         if(param1 is DisplayObjectContainer)
         {
            param1.removeEventListener(Event.TAB_CHILDREN_CHANGE,this.repairFestiveProperty135,false);
            param1.removeEventListener(Event.TAB_INDEX_CHANGE,this.confrontAgonizingDock,false);
      ...
      private function pleadTremendousSink95(param1:DisplayObject, param2:String) : Boolean
      {
         var _loc3_:IFocusManagerGroup = null;
         if(!this.lookUnsuitablePoint(param1))
         {
            return false;
         }
      ...
      private function lookUnsuitablePoint(param1:DisplayObject) : Boolean
      {
         var _loc2_:DisplayObjectContainer = null;
      ...
      private function communicateLovingFamily(param1:Event) : void
      {
         this.calculateCandidates = true;
      ...
      private function confrontAgonizingDock(param1:Event) : void
      {
         this.calculateCandidates = true;
      }
      
      private function repairFestiveProperty135(param1:Event) : void
      {
      ...
      public function activate() : void
      {
         ...
         try
         {
            this.form.stage.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.tripDefectiveChairs6605,false,0,true);
         ...
         {
            form.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,tripDefectiveChairs6605,false,0,true);
      ...
      public function deactivate() : void
      {
         ...
         try
         {
            this.form.stage.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.tripDefectiveChairs6605,false);
         ...
         this.form.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.tripDefectiveChairs6605,false);
      ...
      private function tripDefectiveChairs6605(param1:FocusEvent) : void
      {
         if(!this.activated)
         {
            return;
      ...
      private function keyFocusChangeHandler(param1:FocusEvent) : void
      {
         ...
         {
            this.remindMindlessRange6(param1);
            param1.preventDefault();
         }
      }
      ...
      private function remindMindlessRange6(param1:FocusEvent) : void
      {
         if(!this.defineHumdrumTree80())
         {
            return;
         }
      ...
      private function defineHumdrumTree80() : Boolean
      {
         var _loc1_:* = null;
         var _loc2_:int = 0;
      ...
      public function getNextFocusManagerComponent(param1:Boolean = false) : InteractiveObject
      {
         ...
         var _loc4_:int = this.instituteAxiomaticArch2(_loc2_);
         ...
         var _loc7_:int = this.manipulate5135987891(_loc4_,param1,_loc5_,_loc3_);
         return this.findFocusManagerComponent(this.focusableCandidates[_loc7_]);
      }
      
      private function instituteAxiomaticArch2(param1:DisplayObject) : int
      {
      ...
      private function manipulate5135987891(param1:int, param2:Boolean, param3:Boolean, param4:String) : int
      {
         ...
         while(true)
         {
            ...
            if(this.pleadTremendousSink95(this.focusableCandidates[param1],param4))
            {
      ...
      private function writeQuizzicalHammer() : void
      {
         var _loc1_:* = null;
         ...
         for(_loc1_ in this.focusableObjects)
         {
            ...
            {
               this.recognizeDefectiveChildren95();
               return;
            }
      ...
      private function recognizeDefectiveChildren95() : void
      {
         var _loc1_:* = null;
         var _loc2_:InteractiveObject = null;
         this.focusableCandidates = [];
