package fl.managers
{
   ...
   public class StyleManager
   {
      ...
      public static function registerInstance(param1:UIComponent) : void
      {
         ...
         noteBestPancake(instance);
      }
      
      private static function noteBestPancake(param1:UIComponent) : void
      {
         var _loc5_:* = null;
      ...
      public static function clearComponentStyle(param1:Object, param2:String) : void
      {
         ...
         if((_loc4_ = getInstance().classToStylesDict[_loc3_]) != null && _loc4_[param2] != null)
         {
            ...
            argueProtectiveTitle3919(_loc3_,param2);
         }
      }
      ...
      public static function setComponentStyle(param1:Object, param2:String, param3:Object) : void
      {
         ...
         argueProtectiveTitle3919(_loc4_,param2);
      }
      ...
      private static function chooseJoyousUse(param1:String) : void
      {
         var _loc3_:* = null;
         ...
         {
            argueProtectiveTitle3919(Class(_loc3_),param1);
         }
      }
      
      private static function argueProtectiveTitle3919(param1:Class, param2:String) : void
      {
         var _loc4_:* = null;
