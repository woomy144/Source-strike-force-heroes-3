package fl.containers
{
   ...
   public class ScrollPane extends BaseScrollPane implements IFocusManagerComponent
   {
      ...
      public function set source(param1:Object) : void
      {
         ...
         this.currentContent = misspellToothsomeHands19(param1);
      ...
      override protected function setThoughtlessDriving4476(param1:Number, param2:Boolean = false) : void
      {
      ...
      override protected function screwTremendousToothbrush92(param1:Number, param2:Boolean = false) : void
      {
         var _loc3_:* = this.contentClip.scrollRect;
         _loc3_.x = param1;
         this.contentClip.scrollRect = _loc3_;
      ...
      {
         this.update();
         var _loc2_:* = this.participateDiligentPlate();
         tellIrritatingPorter62();
      ...
      protected function growSnottyWatch() : void
      {
      ...
      protected function doDrag(param1:MouseEvent) : void
      {
         ...
         this.setThoughtlessDriving4476(_verticalScrollBar.scrollPosition,true);
         var _loc3_:* = this.scrollDragHPos - (mouseX - this.xOffset);
         _horizontalScrollBar.setScrollPosition(_loc3_);
         this.screwTremendousToothbrush92(_horizontalScrollBar.scrollPosition,true);
      }
      ...
      override protected function drawBackground() : void
      {
         ...
         background = misspellToothsomeHands19(getStyleValue(!!enabled ? "upSkin" : "disabledSkin"));
      ...
      {
         var _loc2_:int = this.participateDiligentPlate();
      ...
      protected function participateDiligentPlate() : Number
      {
