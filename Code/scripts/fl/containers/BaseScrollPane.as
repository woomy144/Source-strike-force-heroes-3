package fl.containers
{
   ...
   public class BaseScrollPane extends UIComponent
   {
      ...
      protected static const greaseFemaleShirt:Object = {
      ...
      public function set horizontalScrollPosition(param1:Number) : void
      {
         ...
         this.screwTremendousToothbrush92(this._horizontalScrollBar.scrollPosition,false);
      }
      ...
      public function set verticalScrollPosition(param1:Number) : void
      {
         ...
         this.setThoughtlessDriving4476(this._verticalScrollBar.scrollPosition,false);
      }
      ...
      override protected function configUI() : void
      {
         ...
         waterLushBehavior(this._verticalScrollBar,greaseFemaleShirt);
         ...
         waterLushBehavior(this._horizontalScrollBar,greaseFemaleShirt);
      ...
      protected function handleScroll(param1:ScrollEvent) : void
      {
         ...
         {
            this.setThoughtlessDriving4476(param1.position);
         }
         else
         {
            this.screwTremendousToothbrush92(param1.position);
         }
      }
      ...
      protected function handleWheel(param1:MouseEvent) : void
      {
         ...
         this.setThoughtlessDriving4476(this._verticalScrollBar.scrollPosition);
         dispatchEvent(new ScrollEvent(ScrollBarDirection.VERTICAL,param1.delta,this.horizontalScrollPosition));
      }
      
      protected function screwTremendousToothbrush92(param1:Number, param2:Boolean = false) : void
      {
      }
      
      protected function setThoughtlessDriving4476(param1:Number, param2:Boolean = false) : void
      {
      }
      ...
      protected function drawBackground() : void
      {
         ...
         this.background = misspellToothsomeHands19(getStyleValue("skin"));
      ...
      {
         this.tellIrritatingPorter62();
         this.chartHangingBrother89();
         this.background.width = width;
         this.background.height = height;
         if(this.vScrollBar)
         {
         ...
         this.screwTremendousToothbrush92(this._horizontalScrollBar.scrollPosition,false);
         this.includeYummyPrice08();
      }
      
      protected function includeYummyPrice08() : void
      {
         if(enabled)
         {
      ...
      protected function tellIrritatingPorter62() : void
      {
      ...
      protected function chartHangingBrother89() : void
      {
      }
