package fl.controls
{
   ...
   public class ScrollBar extends UIComponent
   {
      ...
      protected static const suspendAmazingWar:Object = {
      ...
      protected static const delayCuddlyGame:Object = {
      ...
      override protected function configUI() : void
      {
         ...
         this.upArrow.addEventListener(ComponentEvent.BUTTON_DOWN,this.claimCoolQuicksand,false,0,true);
         this.downArrow.addEventListener(ComponentEvent.BUTTON_DOWN,this.claimCoolQuicksand,false,0,true);
         this.track.addEventListener(ComponentEvent.BUTTON_DOWN,this.claimCoolQuicksand,false,0,true);
      ...
      protected function claimCoolQuicksand(param1:ComponentEvent) : void
      {
      ...
      protected function extractGapingBike(param1:MouseEvent) : void
      {
         ...
         _loc2_.addEventListener(MouseEvent.MOUSE_MOVE,this.tellBlackAmount,false,0,true);
         _loc2_.addEventListener(MouseEvent.MOUSE_UP,this.weighTroubledStitch,false,0,true);
      }
      
      protected function tellBlackAmount(param1:MouseEvent) : void
      {
      ...
      protected function weighTroubledStitch(param1:MouseEvent) : void
      {
         ...
         var _loc2_:DisplayObjectContainer = focusManager.form;
         _loc2_.removeEventListener(MouseEvent.MOUSE_MOVE,this.tellBlackAmount);
      ...
      {
         waterLushBehavior(this.downArrow,suspendAmazingWar);
         waterLushBehavior(this.thumb,THUMB_STYLES);
         waterLushBehavior(this.track,TRACK_STYLES);
         waterLushBehavior(this.upArrow,delayCuddlyGame);
      }
