package fl.controls
{
   ...
   public class BaseButton extends UIComponent
   {
      ...
      protected function drownFragileNeck() : void
      {
         addEventListener(MouseEvent.ROLL_OVER,this.expressUnrulyZinc,false,0,true);
         addEventListener(MouseEvent.MOUSE_DOWN,this.expressUnrulyZinc,false,0,true);
         addEventListener(MouseEvent.MOUSE_UP,this.expressUnrulyZinc,false,0,true);
         addEventListener(MouseEvent.ROLL_OUT,this.expressUnrulyZinc,false,0,true);
      }
      
      protected function expressUnrulyZinc(param1:MouseEvent) : void
      {
      ...
      protected function drawBackground() : void
      {
         ...
         this.background = misspellToothsomeHands19(getStyleValue(_loc1_));
