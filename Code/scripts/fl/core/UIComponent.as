package fl.core
{
   ...
   public class UIComponent extends Sprite
   {
      ...
      private static var nestOmniscientTax:Dictionary = new Dictionary(true);
      ...
      public function UIComponent()
      {
         ...
         this.marryObservantPickle04();
         addEventListener(Event.ENTER_FRAME,this.branchScaredGrass,false,0,true);
      }
      ...
      public function set componentInspectorSetting(param1:Boolean) : void
      {
         ...
         if(this._inspector)
         {
            this.plugForgetfulWilderness43();
         }
         else
         {
            this.accomplishAbortiveSchool();
         }
      }
      
      protected function plugForgetfulWilderness43() : void
      {
      }
      
      protected function accomplishAbortiveSchool() : void
      {
      }
      ...
      public function drawFocus(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.uiFocusRect = this.misspellToothsomeHands19(this.getStyleValue("focusRectSkin")) as Sprite;
      ...
      {
         this.isLivePreview = this.unpackAlikeSense();
      ...
      protected function unpackAlikeSense() : Boolean
      {
      ...
      protected function misspellToothsomeHands19(param1:Object) : DisplayObject
      {
      ...
      protected function waterLushBehavior(param1:UIComponent, param2:Object) : void
      {
         var _loc3_:* = null;
      ...
      protected function callLater(param1:Function) : void
      {
         ...
         if(stage != null)
         {
            try
            {
               stage.addEventListener(Event.RENDER,this.detectPatheticCloud,false,0,true);
               stage.invalidate();
            }
            catch(se:SecurityError)
            {
               addEventListener(Event.ENTER_FRAME,detectPatheticCloud,false,0,true);
            }
         }
         else
         {
            addEventListener(Event.ADDED_TO_STAGE,this.detectPatheticCloud,false,0,true);
         }
      }
      
      private function detectPatheticCloud(param1:Event) : void
      {
         ...
         if(event.type == Event.ADDED_TO_STAGE)
         {
            try
            {
               removeEventListener(Event.ADDED_TO_STAGE,this.detectPatheticCloud);
               stage.addEventListener(Event.RENDER,this.detectPatheticCloud,false,0,true);
               stage.invalidate();
               return;
            }
         ...
         {
            event.target.removeEventListener(Event.RENDER,this.detectPatheticCloud);
            event.target.removeEventListener(Event.ENTER_FRAME,this.detectPatheticCloud);
            try
            {
               if(stage == null)
               {
      ...
      private function marryObservantPickle04() : void
      {
         ...
         {
            this.stitchDirefulHall6();
            _loc1_ = this.focusManager;
            if(_loc1_ != null)
            {
               _loc2_ = nestOmniscientTax[_loc1_];
               if(_loc2_ == null)
               {
                  _loc2_ = new Dictionary(true);
                  nestOmniscientTax[_loc1_] = _loc2_;
               }
               _loc2_[this] = true;
            }
         }
      ...
      private function removedHandler(param1:Event) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = nestOmniscientTax[_loc2_];
            if(_loc3_ != null)
            {
               delete _loc3_[this];
               _loc4_ = true;
               ...
               if(_loc4_)
               {
                  delete nestOmniscientTax[_loc2_];
                  _loc3_ = null;
               }
            }
            if(_loc3_ == null)
      ...
      protected function stitchDirefulHall6() : void
      {
      ...
      protected function branchScaredGrass(param1:Event) : void
      {
         removeEventListener(Event.ENTER_FRAME,this.branchScaredGrass);
         this.overdrawScatteredBadge9();
      }
      
      protected function overdrawScatteredBadge9() : void
      {
